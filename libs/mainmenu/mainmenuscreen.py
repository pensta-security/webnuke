class MainMenuScreen:
    ...
    def drawscreen(self):
        ...
        self.screen.addstr(14, 4, "cms          - CMS info menu...")
        self.screen.addstr(15, 4, "xss          - XSS...")
        self.screen.addstr(17, 4, "debug        - toggle debug on/off")
        self.screen.addstr(18, 4, "proxy        - set proxy settings...")
        self.screen.addstr(19, 4, "!sh          - escape to unix land...")
        self.screen.addstr(21, 4, "quit         - Exit webnuke")
